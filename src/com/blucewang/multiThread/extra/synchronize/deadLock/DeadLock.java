...
class ResourceA {
    public synchronized void getResourceBName(ResourceB b) {
        ...
        System.out.println(Thread.currentThread().getName() + "线程准备调用ResourceB方法来获取B中的名称");
        b.printName();
    }
...
class ResourceB {
    ...
    public synchronized void getResourceAName(ResourceA a) {
        ...
        System.out.println(Thread.currentThread().getName() + "线程准备调用ResourceA方法来获取A中的名称");
        a.printName();
    }
}
...
public class DeadLock implements Runnable{
    ...
    public static void main(String[] args) {
        ...
        new Thread(deadLock,"死锁测试线程").start();
        deadLock.initB();
    }
}
